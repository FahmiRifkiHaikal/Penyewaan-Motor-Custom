...
<body>
    <div style="font-family: Arial, sans-serif; margin: 0; padding: 0; display: flex; justify-content: center; align-items: center; height: 100vh;">
        <div style="width: 300px; padding: 20px; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); text-align: center;">
            ...
            <h2 style="color: #333; margin-bottom: 20px;">Registrasi</h2>
            <form action="proses-registrasi.php" method="post">
                ...
                <input type="email" id="email" name="email" required style="width: 100%; padding: 10px; margin-bottom: 20px; border: 1px solid #ccc; border-radius: 3px;">
                ...
                <button type="submit" style="background-color: #3e4a52; color: #fff; padding: 20px 30px; border: none; border-radius: 3px; cursor: pointer; transition: background-color 0.3s ease;">Registrasi</button>
            </form>
            
            <p>Sudah punya akun? <a href="login.html" style="color: #2980b9;">Login di sini</a></p>
            
            <button onclick="window.location.href = 'index.html';" style="background-color: #ccc; color: #333; padding: 10px 20px; border: none; border-radius: 3px; cursor: pointer; transition: background-color 0.3s ease; margin-top: 20px;">Kembali ke Halaman Awal</button>
        </div>
    </div>
</body>
</html>
